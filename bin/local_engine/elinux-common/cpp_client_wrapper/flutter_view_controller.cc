...
FlutterViewController::FlutterViewController(
  ...
  c_view_properties.use_ivi_shell = view_properties.use_ivi_shell;
  c_view_properties.ivi_surface_id = view_properties.ivi_surface_id;
  c_view_properties.ivi_layer_id = view_properties.ivi_layer_id;
  c_view_properties.ivi_surface_x = view_properties.ivi_surface_x;
  c_view_properties.ivi_surface_y = view_properties.ivi_surface_y;
